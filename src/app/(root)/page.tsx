...
import { ArrowBigDown, ArrowUpIcon, ChevronDown } from "lucide-react";
        ...
        <>
                ...
                >
                    <div className="px-5 md:px-24 w-full max-[1024px]:pt-20">
                        ...
                        <div className="max-w-full mx-auto grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-y-10 gap-x-6">
                            ...
                            <div onClick={scrollToConnect} className="icon-ts flex flex-col items-center justify-center gap-2 cursor-pointer transition-colors duration-300 ease-in-out">
                                <div className="relative w-12 h-12 max-[440px]:w-10 max-[440px]:h-10 md:w-16 md:h-16 rounded-lg flex items-center justify-center text-2xl font-bold bg-gray-600 hover:text-white text-gray-400">
                                    <ArrowBigDown />
                                </div>
            ...
            <div className="invisible absolute right-10 max-[400px]:right-3 bottom-10 z-20">
                <Button size="icon-lg" asChild>
                    <div className="p-4 w-15 h-15">
                        <ArrowUpIcon size={100}/>
                    </div>
                </Button>
            </div>
        </>
